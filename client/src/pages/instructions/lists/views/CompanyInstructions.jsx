...
const CompanyInstructions = () => {
    ...
    const fetchInstructions = async () => {
      try {
        ...
        if (clientId) {
          ...
          console.log(
            `Filtered to ${filteredData.length} instructions for clientId: ${clientId}`
          );
        }
  ...
  const handleViewAssignment = (instructionId) => {
    console.log(
      `Navigating to DirectorManagerViewAssignment with instructionId: ${instructionId}`
    );
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleViewInstruction(
                              item.m1controllerkey || item.m1key
                            )
                          }
                        >
                          View
