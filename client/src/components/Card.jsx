...
const ICONS = {
  ...
  "Track Instruction": '<path d="m3 11 18-8-8 18-2-8-8-2z"/>',
  Insights: '<path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="m19 9-5 5-4-4-3 3"/>',
  Analytics:
    '<path d="M3 3v16a2 2 0 0 0 2 2h16"/><rect x="7" y="13" width="3" height="5"/><rect x="12" y="9" width="3" height="9"/><rect x="17" y="6" width="3" height="12"/>',
  "Age Analysis":
  ...
  Payroll: '<rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/>',
  "Payment Received":
  ...
  Fuel: '<path d="M12 2.69 17.66 8.34a8 8 0 1 1-11.31 0Z"/>',
  Subcontractors:
...
const DEFAULT_ICON = '<rect width="18" height="18" x="3" y="3" rx="2"/>';
