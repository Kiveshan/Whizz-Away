...
const creditorsDashboardData = [
  ...
  { title: "Subcontractors", image: "/images/subconstructor.jpg", path: "/Creditors/subcontractor" },
  { title: "Wages", image: "/images/wages.jpeg", path: "/finance-clerk-wage" },
  { title: "Other Expenses", image: "/images/OtherExpence.jpg", path: "/Creditors/CreditorsOther" },
]
