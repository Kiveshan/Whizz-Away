...
const DMcontrollerinstructions = () => {
  ...
  console.log("DMcontrollerinstructions received state:", {
    instructionId,
    clientId,
    clientName,
    selectedMonth,
  ...
  const handleViewContainerDetails = () => {
    ...
    navigate("/DMcontrollerInstructionDetails", {
      state: {
...
export default DMcontrollerinstructions
