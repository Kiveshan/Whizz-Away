...
const DirectorManagerViewFuelExpence = ({ onViewTruck }) => {
  ...
  return (
    <div className="expenses-container">
      <div className="client-payments-header">
        <button className="back-button" onClick={() => navigate("/DirectorCreditorsDash")}>
          Back
        </button>
      </div>
            ...
            <tr key={index}>
              ...
              <td>
                <button
                  ...
                  onClick={() => navigate("/DirectorExpenses")}
                >
                  View
                </button>
              </td>
...
export default DirectorManagerViewFuelExpence;
