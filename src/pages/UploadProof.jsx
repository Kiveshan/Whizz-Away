    ...
    <div className="upload-container">
      ...
      <div className="upload-content">
        ...
        <div className="info-box">
          <p>Once your proof of payment amount paid matches the balance, it will be submitted from both sides.</p>
          <p className="info-note">Note: this is for verification purposes</p>
        </div>
      </div>
    </div>
  )
