...
//             {isCompleted ? "View Documents" : "Finalise"}
//           </button>
//         </div>
//       )}
...
//                           Driver: <span className="text-green-600 font-medium">{entry.full_name || "None"}</span>
//                         </label>
//                         <select
...
//                         <label className="block text-gray-700 mb-1">
//                           Truck Reg Number:{" "}
//                           <span className="text-green-600 font-medium">{entry.truckregnumber || "None"}</span>
//                         </label>
//                         <select
//                           className="w-full p-2 border rounded-md appearance-none"
//                           onChange={(e) => {
...
//                               {/* selected={entry.truckregnumber === truck}   */}
//                               {truck}
//                             </option>
//                           ))}
//                         </select>
...
//                         <label className="block text-gray-700 mb-1">
//                           Container Number:{" "}
//                           <span className="text-green-600 font-medium">{entry.containernumber || "None"}</span>
//                         </label>
//                         <select
//                           className="w-full p-2 border rounded-md appearance-none"
//                           onChange={(e) => {
...
//                               // selected={entry.containernumber === container.toString()}
//                             >
//                               {container}
//                             </option>
//                           ))}
...
//                 <div className={`modal-checkbox checked`}>
//                   <svg
//                     className="modal-checkbox-icon"
//                     xmlns="http://www.w3.org/2000/svg"
//                     viewBox="0 0 24 24"
...
//               <p className="modal-description">Please save changes before finalisation.</p>
//             </div>
//             <div className="modal-footer">
...
//       {/* Pickup Mismatch Modal */}
//       {showPickupMismatchModal && (
//         <div className="modal-wrapper">
//           <div className="modal-backdrop animate-fadeIn"></div>
//           <div className="modal-container animate-scaleIn">
//             <div className="modal-header">
//               <h3 className="modal-title">Pickup Location Mismatch</h3>
//               <p className="modal-description">
//                 The first leg starting point doesn't match the instruction pickup location.
//               </p>
//             </div>
//             <div className="modal-body">
//               <div className="modal-item">
//                 {/* Remove the "checked" class since the starting points don't match */}
//                 <div className={`modal-checkbox`}>
//                   <svg
//                     className="modal-checkbox-icon"
//                     xmlns="http://www.w3.org/2000/svg"
...
//                 </div>
//                 <span className="modal-item-text">
//                   First Leg Starting Point: <strong>{pickupMismatchDetails.firstLegStartingPoint}</strong>
//                 </span>
//               </div>
//               <div className="modal-item">
//                 {/* Add the "checked" class to the pickup location to indicate it's the correct one */}
//                 <div className={`modal-checkbox checked`}>
//                   <svg
//                     className="modal-checkbox-icon"
//                     xmlns="http://www.w3.org/2000/svg"
...
//                 </div>
//                 <span className="modal-item-text">
//                   Instruction Pickup: <strong>{pickupMismatchDetails.pickup}</strong>
//                 </span>
//               </div>
//               <div className="modal-item">
//                 <div className={`modal-checkbox`}>
...
//                 </div>
//                 <span className="modal-item-text">
//                   Please update the first leg starting point or edit the instruction.
//                 </span>
//               </div>
//             </div>
//             <div className="modal-footer">
//               <button className="modal-btn modal-btn-primary" onClick={() => setShowPickupMismatchModal(false)}>
//                 Okay
//               </button>
//             </div>
//           </div>
                        ...
                        >
                          ...
                          {containerOptions
                            .filter((container) => {
                              ...
                              return !hasContainerReachedDropoff(container.toString())
                            })
                            .map((container) => (
                              <option key={container} value={container.toString()}>
                                {container}
                              </option>
                            ))}
                        </select>
