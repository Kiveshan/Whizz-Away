...
import '../finance clerkpages/css/DriverWage.css';

const DriverWage = () => {
  const navigate = useNavigate()
  const [activeView, setActiveView] = useState("list")
  const [selectedDriver, setSelectedDriver] = useState(null)
  const [ setSelectedDelivery] = useState(null)

  const drivers = [
    { name: "Driver Name 1", wage: "R 5,434" },
    { name: "Driver Name 2", wage: "R 8,923" },
    { name: "Driver Name 3", wage: "R 6,448" },
    { name: "Driver Name 4", wage: "R 3,235" },
  ]
        ...
        {deliveries.map((delivery, index) => (
          <div key={index} className="table-row">
            ...
            <div className="table-cell actions">
              <button className="view-button" onClick={() => handleViewSlip(delivery)}>
                View
              </button>
